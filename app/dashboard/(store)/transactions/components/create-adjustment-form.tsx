...
export function CreateAdjustmentForm({
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      product: '',
      description: '',
      quantityAdjusted: undefined,
      adjustmentDate: undefined,
      typeOfTransaction: 'ADJUSTMENT',
    },
  });
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Quantity Adjusted <span className='text-red-600'>*</span>
                </FormLabel>
                <FormControl>
                  <Input
                    type='number'
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex flex-col'>
                <FormLabel>
                  Adjustment Date <span className='text-red-600'>*</span>
                </FormLabel>
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='col-span-full'>
                ...
                <FormControl>
                  <Textarea
                    placeholder='A brief description of why this product is considered adjusted.'
                    {...field}
                  />
                </FormControl>
                <FormMessage />
