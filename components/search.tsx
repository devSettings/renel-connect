  ...
  return (
    <div className='relative w-full md:w-auto'>
      ...
      <Input
        ...
        className={cn(
          'flex h-11 w-full text-base rounded-md   border-gray-300 border-input bg-background px-3 py-2 pl-8  ring-offset-background transition-all ease-linear duration-300',
